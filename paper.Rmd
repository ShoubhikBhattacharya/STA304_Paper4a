---
title: 'Places of child delivery and health: Trends from Turkey in the 1998 Demographic and Health Survey'
author:
- Meha Grewal
- Ayoon Kim
...
abstract: A family’s future health and wellness largely depends on the well-being
  ...
  Turkey.
thanks: 'Code and data are available at: https://github.com/ShoubhikBhattacharya/STA304_Paper4a'
toc: no
...
plot1 <- ggplot2::ggplot(df1, aes(x = age, y=score, fill = legend)) + 
  ...
  labs(title = "Figure 2: Place of Delivery by Mother's age at birth", x ="Age groups", y = "Count in %") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

plot2 <- ggplot2::ggplot(df2, aes(x = BirthOrder, y= score, fill = legend)) + geom_col(position = "dodge") + 
  labs(title = "Figure 3: Place of Delivery by Child's birth order", x ="Birth order position", y = "Count in %")

plot3 <- ggplot2::ggplot(df3, aes(x = Residence, y = score, fill = legend)) + geom_col(position = "dodge") + 
  labs(title = "Figure 4: Place of Delivery by Residence", x ="Residence", y = "Count in %")

plot4 <- ggplot2::ggplot(df4, aes(x = Education, y = score, fill = legend)) + geom_col(position = "dodge") + 
  labs(title = "Figure 5: Place of Delivery by Mother's education level", x ="Educational level", y = "Count in %") + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

plot5 <- ggplot2::ggplot(df5, aes(x = Region, y = score, fill = legend)) + geom_col(position = "dodge") + 
  labs(title = "Figure 6: Place of Delivery by Region", x ="Region", y = "Count in %")

plot6 <- ggplot2::ggplot(df6, aes(x = AC_Visits, y = score, fill = legend)) + geom_col(position = "dodge") + 
  labs(title = "Figure 7: Place of Delivery by AC visits", x ="Number of Visits", y = "Count in %")
```
...
plot1
```
These plots summarize the variables in our data set and how it impacts the place of delivery. To begin with mother's age in Figure 2\@ref(fig:plot1), the vast majority of mothers give birth at a health facility. However, a larger portion of mothers aged 35 and above give birth at home. 
...
(Figure 5 \@ref(fig:plot4)) showcases how education level impacts place of delivery. Mothers with no education largely delivered at home. The higher the mother’s educational level, the larger the likelihood of them delivering their child at a health facility. 
